...
TERMOS = {
    ...
    "descritivo técnico do objeto": ["descritivo técnico", "descritivo tecnico", "descrição técnica", "descricao tecnica", "objeto", "esculturas temáticas", "esculturas tematicas", "fibra de vidro"],
    "memorial descritivo das peças, dimensões e locais de instalação": ["memorial descritivo", "dimensões", "dimensoes", "locais de instalação", "locais de instalacao", "projeto executivo", "layout de implantação", "layout de implantacao"],
    "critérios de segurança, acabamento, fixação e uso externo": ["segurança", "seguranca", "acabamento", "fixação", "fixacao", "uso externo", "proteção uv", "protecao uv", "intempéries", "intemperies", "arestas cortantes"],
    "projeto executivo ou layout de implantação, se houver": ["projeto executivo", "layout", "planta", "implantação", "implantacao", "local de instalação", "local de instalacao"],
}
